...
export async function consulta_1(db) {
...
export async function consulta_2(db) {
...
export async function consulta_3(db) {
  const results = await db
    .collection("Data")
...
export async function consulta_4(db) {
  const results = await db
    .collection("Data")
...
export async function consulta_5(db) {
...
export async function consulta_6(db) {
...
export async function consulta_7(db) {
...
export async function consulta_8(db) {
  const results = await db
    .collection("Data")
...
export async function consulta_9(db) {
  const results = await db
    .collection("Data")
...
export async function consulta_10(db) {
  const results = await db
    .collection("Data")
...
export async function consulta_11(db) {
  const results = await db
    .collection("Data")
    .find({
...
export async function consulta_12(db) {
  const results = await db
    .collection("Data")
    .find({
      cuisine: { $ne: "American" },
...
export async function consulta_13(db) {
  const results = await db
    .collection("Data")
    .find({
      cuisine: { $ne: "American" },
...
export async function consulta_14(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_15(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_16(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_17(db) {
  const results = await db
    .collection("Data")
    .find({
      borough: "Bronx",
...
export async function consulta_18(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_19(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_20(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_21(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_22(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_23(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_24(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_25(db) {
...
export async function consulta_26(db) {
  const results = await db.collection("Data").find({}).sort({ name: -1 }).toArray();
  console.log(results);
}
...
export async function consulta_27(db) {
...
export async function consulta_28(db) {
  const results = await db
    .collection("Data")
...
export async function consulta_29(db) {
  const results = await db
    .collection("Data")
...
export async function consulta_30(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_31(db) {
  const results = await db
    .collection("Data")
    .find(
      {
...
export async function consulta_32(db) {
  const results = await db
    .collection("Data")
    .find(
      {
